...
export const styles = StyleSheet.create({
  ...
  modalOverlay: {flex: 1, backgroundColor: '#00000088', justifyContent: 'center', paddingHorizontal: spacing.lg},
  ...
  lineGrid: {flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm, justifyContent: 'flex-start'},
  ...
  // Continuous track drawn behind all nodes
  wizardTrack: {
    position: 'absolute',
    top: 17,
    left: spacing.lg + 9,
  ...
  // kept for TypeScript compat — visually replaced by wizardTrack
  wizardStepConnector: {display: 'none' as any},
  wizardStepConnectorComplete: {display: 'none' as any},
  wizardStepCircle: {
    width: 18,
    height: 18,
    borderRadius: 9,
