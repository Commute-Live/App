...
export const styles = StyleSheet.create({
  ...
  cityPickerSection: {gap: spacing.md, paddingTop: spacing.sm},
  ...
  stepTitle: {color: colors.text, fontSize: 22, fontWeight: '900', marginBottom: spacing.xxs},
  stepSubtitle: {color: colors.textMuted, fontSize: 13, marginBottom: spacing.md},
  ...
  lineBadgeCircle: {width: 50, height: 50, borderRadius: 25, alignItems: 'center', justifyContent: 'center'},
  ...
  stopPickerDirRow: {flexDirection: 'row', gap: 4, justifyContent: 'center', alignSelf: 'center'},
  ...
  stopPickerDirTextChicagoTrain: {fontSize: 10, lineHeight: 12, textAlign: 'center'},
  stopPickerDirTextBoston: {fontSize: 9, lineHeight: 11, textAlign: 'center'},
